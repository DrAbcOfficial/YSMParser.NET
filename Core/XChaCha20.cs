...
public static class XChaCha20
{
    ...
    private static uint Rotl32(uint v, int n) => (v << n) | (v >> (32 - n));

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    private static uint U8To32Le(ReadOnlySpan<byte> p) =>
        (uint)p[0] | ((uint)p[1] << 8) | ((uint)p[2] << 16) | ((uint)p[3] << 24);

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    private static void U32To8Le(Span<byte> p, uint v)
    {
        p[0] = (byte)(v);
        p[1] = (byte)(v >> 8);
        p[2] = (byte)(v >> 16);
    ...
    public static void HChaCha20(Span<byte> output, ReadOnlySpan<byte> input, ReadOnlySpan<byte> key, uint rounds)
    {
        ...
        uint x4 = U8To32Le(key.Slice(0, 4));
        uint x5 = U8To32Le(key.Slice(4, 4));
        uint x6 = U8To32Le(key.Slice(8, 4));
        uint x7 = U8To32Le(key.Slice(12, 4));
        uint x8 = U8To32Le(key.Slice(16, 4));
        uint x9 = U8To32Le(key.Slice(20, 4));
        uint x10 = U8To32Le(key.Slice(24, 4));
        uint x11 = U8To32Le(key.Slice(28, 4));
        uint x12 = U8To32Le(input.Slice(0, 4));
        uint x13 = U8To32Le(input.Slice(4, 4));
        uint x14 = U8To32Le(input.Slice(8, 4));
        uint x15 = U8To32Le(input.Slice(12, 4));
        ...
        U32To8Le(output.Slice(0, 4), x0);
        U32To8Le(output.Slice(4, 4), x1);
        U32To8Le(output.Slice(8, 4), x2);
        U32To8Le(output.Slice(12, 4), x3);
        U32To8Le(output.Slice(16, 4), x12);
        U32To8Le(output.Slice(20, 4), x13);
        U32To8Le(output.Slice(24, 4), x14);
        U32To8Le(output.Slice(28, 4), x15);
    }
    ...
    public static void KeySetup(XChaChaCtx ctx, ReadOnlySpan<byte> key, ReadOnlySpan<byte> iv)
    {
        ...
        ctx.Input[4] = U8To32Le(k2.Slice(0, 4));
        ctx.Input[5] = U8To32Le(k2.Slice(4, 4));
        ctx.Input[6] = U8To32Le(k2.Slice(8, 4));
        ctx.Input[7] = U8To32Le(k2.Slice(12, 4));
        ctx.Input[8] = U8To32Le(k2.Slice(16, 4));
        ctx.Input[9] = U8To32Le(k2.Slice(20, 4));
        ctx.Input[10] = U8To32Le(k2.Slice(24, 4));
        ctx.Input[11] = U8To32Le(k2.Slice(28, 4));
        ctx.Input[12] = 0;
        ctx.Input[13] = 0;
        ctx.Input[14] = U8To32Le(iv.Slice(16, 4));
        ctx.Input[15] = U8To32Le(iv.Slice(20, 4));
    }
    ...
    private static void EncryptBlock(XChaChaCtx ctx, ReadOnlySpan<byte> m, Span<byte> c, uint j12Init, uint j13Init)
    {
        ...
        x0 ^= U8To32Le(m.Slice(0, 4));
        x1 ^= U8To32Le(m.Slice(4, 4));
        x2 ^= U8To32Le(m.Slice(8, 4));
        x3 ^= U8To32Le(m.Slice(12, 4));
        x4 ^= U8To32Le(m.Slice(16, 4));
        x5 ^= U8To32Le(m.Slice(20, 4));
        x6 ^= U8To32Le(m.Slice(24, 4));
        x7 ^= U8To32Le(m.Slice(28, 4));
        x8 ^= U8To32Le(m.Slice(32, 4));
        x9 ^= U8To32Le(m.Slice(36, 4));
        x10 ^= U8To32Le(m.Slice(40, 4));
        x11 ^= U8To32Le(m.Slice(44, 4));
        x12 ^= U8To32Le(m.Slice(48, 4));
        x13 ^= U8To32Le(m.Slice(52, 4));
        x14 ^= U8To32Le(m.Slice(56, 4));
        x15 ^= U8To32Le(m.Slice(60, 4));

        U32To8Le(c.Slice(0, 4), x0);
        U32To8Le(c.Slice(4, 4), x1);
        U32To8Le(c.Slice(8, 4), x2);
        U32To8Le(c.Slice(12, 4), x3);
        U32To8Le(c.Slice(16, 4), x4);
        U32To8Le(c.Slice(20, 4), x5);
        U32To8Le(c.Slice(24, 4), x6);
        U32To8Le(c.Slice(28, 4), x7);
        U32To8Le(c.Slice(32, 4), x8);
        U32To8Le(c.Slice(36, 4), x9);
        U32To8Le(c.Slice(40, 4), x10);
        U32To8Le(c.Slice(44, 4), x11);
        U32To8Le(c.Slice(48, 4), x12);
        U32To8Le(c.Slice(52, 4), x13);
        U32To8Le(c.Slice(56, 4), x14);
        U32To8Le(c.Slice(60, 4), x15);
    }
